            ...
            <x-tabs :active="$initialTab">
                ...
                <x-slot name="header">
                    ...
                    <x-tab-link tab="contacto-emergencia" :error="$errors->hasAny($errorGroups['contacto-emergencia'])">
                        <i class="fa-solid fa-heart-pulse me-2"></i> Contacto de emergencia
                    </x-tab-link>
                </x-slot>
                ...
                <x-tab-content tab="datos-personales">
                    <div class="bg-blue-100 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-sm">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div class="flex-shrink-0">
                                <x-wire-button primary sm href="{{ route('admin.usuarios.edit', $patient->user) }}" target="_blank">
                ...
                <x-tab-content tab="contacto-emergencia">
                    <div class="grid lg:grid-cols-2 gap-4">
                        ...
                        <x-wire-phone label="Teléfono del contacto" name="emergency_contact_phone" mask="(###)- ### ####" placeholder="(999) - 999 9999" value="{{ old('emergency_contact_phone', $patient->emergency_contact_phone) }}"></x-wire-phone>
