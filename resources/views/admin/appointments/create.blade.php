...
<div class="max-w-3xl mx-auto py-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-indigo-500 px-6 py-5">
            ...
            <p class="text-indigo-100 text-sm mt-0.5">Complete el formulario para agendar una cita.</p>
        </div>

        {{-- Formulario --}}
        <form action="{{ route('admin.appointments.store') }}" method="POST" class="px-6 py-6 space-y-6">
            @csrf
